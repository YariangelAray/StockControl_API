...
/**
 * Define los campos esperados y sus reglas de validación para la entidad "Genero".
 * 
 * Esta clase proporciona una lista de objetos `Campo` que detallan los campos que se deben
 * validar en las peticiones relacionadas con géneros (crear, actualizar, etc.).
 * 
...
public class CamposGenero {
    ...
    /**
     * Retorna la lista de campos a validar para un objeto de tipo Genero.
     * 
